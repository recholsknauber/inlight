...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30838 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30838(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30849 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30849(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30857 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30857(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30859 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30859(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30866 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30866(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30868 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30868(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30874 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30874(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30876 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30876(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30877 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30877(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30882 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30882(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30890 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30890(b);
}
});
