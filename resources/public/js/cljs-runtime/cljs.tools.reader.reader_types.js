...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26317 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26317(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26331 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26331(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26334 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26334(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26336 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26336(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26337 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26337(reader);
}
});
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26339(reader);
}
});
...
var G__26392 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26393 = s.append(c);
c = G__26392;
s = G__26393;
continue;
}
